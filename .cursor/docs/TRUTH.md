# The Project Truth (Vader Engine v2.7.0)
...
**Shipped release:** Root **`package.json` → `version`** is **2.7.0**. Release tags: `v2.1.0` … `v2.7.0`. Product deltas: **[`UPDATE_LOG.md`](./UPDATE_LOG.md)**, **[`project-log.md`](./project-log.md)**. Branch history: **[`Checkpoint.md`](./Checkpoint.md)**.
...
**Signature:** Powered by the MSC Media Engine · Vader Engine v2.7.0
