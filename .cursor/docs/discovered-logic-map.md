...
Deep scan of pillar repositories vs Boilerplate-v1. Items marked **ported** exist in this repo; **stub** require consumer wiring; **doc-only** are rituals documented but not executable here.
