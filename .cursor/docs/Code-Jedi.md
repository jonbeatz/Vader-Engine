...
| `npm run grade` | v2.7.0 / release audit | `msc-grade-boilerplate.mjs` → structural PASS/FAIL vs TRUTH + Code-Jedi layout (exit **1** on any fail; **61/61**) |
...
### Bootstrap, sandboxes & quality (v2.7.0)
...
*Maintained as the primary AI routing compass for Vader Engine v2.7.0. Update when `package.json` scripts or core module paths change.*
