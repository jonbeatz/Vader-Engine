...
Single source of truth for repository layout, subsystem boundaries, and integration contracts. Aligns with [README.md](../../README.md) (v2.6.0). Agent routing compass: [Code-Jedi.md](./Code-Jedi.md). Technical precedence: [TRUTH.md](../../TRUTH.md).
