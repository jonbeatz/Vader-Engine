...
export function MscHeroSlider({
  ...
  const slides = useMemo(() => {
    const source = slidesProp && slidesProp.length > 0 ? slidesProp : MSC_PLACEHOLDER_SLIDES;
    ...
    >
      ...
      >
        ...
        <h1 className="msc-hero-slider__headline">
          ...
          <span className="msc-hero-slider__headline-accent block">{slide.headline[2]}</span>
        </h1>
          ...
          {slides.map((_, i) => (
            <button
              ...
              className={[
                ...
                i === current ? 'msc-hero-slider__dot--active' : 'msc-hero-slider__dot--inactive',
              ].join(' ')}
            />
          ))}
          <span
          ...
          >
            {stats.map((stat) => (
              <div
                ...
                style={{
                  borderColor: stat.highlight ? 'var(--msc-accent, #e02b20)' : undefined,
                }}
              >
                <div
                  style={{
