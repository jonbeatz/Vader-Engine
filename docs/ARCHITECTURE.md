...
High-level layout of **Vader Engine v2.6.0** ([jonbeatz/Vader-Engine](https://github.com/jonbeatz/Vader-Engine)).
...
## Template scaffolding layer (v2.4.0)
...
| Structural grader | `npm run grade` | Pre-push, CI — **61 checks** |
